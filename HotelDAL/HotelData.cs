    ...
    public static class HotelData
    {
        ...
        static HotelData()
        {
            DataTable[] tables = {
                ...
                gain.GetTable("select * from ConsumptionRecord", null, "ConsumptionRecord"), // 获取数据库的 消费 记录信息
                gain.GetTable("select * from UserRechargeTable", null, "UserRechargeTable") // 获取数据库的 充值 记录信息
            };
            // 向程序的临时数据库上传获得的各项数据表
